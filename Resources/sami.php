...
$sami = new Sami($iterator, [
    'title' => 'Dashboard Builder', // This will be the name of the docs
    'build_dir' => 'build/docs/sami-docs', // This will be the folder the docs will be put in
    'cache_dir' => 'build/docs/sami-cache', // This will be generated by sami, but you can .gitignore it
